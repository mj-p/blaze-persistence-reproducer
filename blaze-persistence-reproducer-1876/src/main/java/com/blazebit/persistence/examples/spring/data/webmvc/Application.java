...
import com.blazebit.persistence.examples.spring.data.webmvc.repository.PersonViewRepository;
...
public class Application implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        PersonView personView = personViewRepository.findOne(person.getId());

        System.out.println("Person ID: " + person.getId());
        System.out.println("PersonView ID: " + personView.getId());
    }
}
